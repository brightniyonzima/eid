...
@include("quick_access_menu")<br><br><br><br>
...
@include('lab.partials._worksheet_menu')
	...
	<table  class="table table-bordered" cellspacing="0" cellpadding="4" align="center" style="margin-top: 1em; border: 1px solid #ddd" >
			...
			<tr style="background-color: #eee">
				...
				<th><small>Turn Around Time</small></th>
				<th><small>Completed?</small></th>
				<th style="text-align: center"><small>Task&nbsp;&nbsp;&nbsp;</small></th>
			</tr>
		...
		@foreach($selected_worksheets as $w)
			...
			<tr class="ws_row" {{ $row_id }}>
				...
				<td> {{ $w->DateCreated }} </td>
				<td> {{ $w->DateReviewed }} 
	                <a href="/eid_review/{{ $w->id }}" class="btn btn-info">Review</a>
				</td>
				...
				<td align="center">
					<div class="btn-group">
						...
						@if (App::environment('testing')) 
							<li class="divider"></li>
							<li><a  action="dummy" 	worksheet="{{ $dws_id }}" href="#"><span class="glyphicon glyphicon-th pull-left" style="color:blue;" >&nbsp;</span>Dummy Data</a></li>
						@endif
