...
<section id='s4' class='mm'></section>
	...
	@if(\Request::has('rj'))
		<div style="float:left; font-weight: bold; font-size: larger">Rejected Results .::. Print &amp; Dispatch</div>		
		<img src="/REJECTED.png" style="height:1.85em; width: auto ; float:left; margin-left: 0.5em;">
	@elseif(\Request::has('scd'))
		<div style="float:left; font-weight: bold; font-size: larger">Sickle Cell Results .::. Print &amp; Dispatch</div>
		<img src="/SCD.png" style="height:2em; width: auto ; float:left; margin-left: 0.5em;">
	@else
		<div style="float:left; font-weight: bold; font-size: larger">EID Results .::. Print &amp; Dispatch</div>
		<img src="/EID.png" style="height:2em; width: auto ; float:left; margin-left: 0.5em;">
	@endif

	{!! make_nav_link("/dispatch", "EID Results") !!} <span class="test_type">&nbsp;|&nbsp;</span>
	{!! make_nav_link("/dispatch?scd=1", "Sickle Cell Results") !!}<span class="test_type">&nbsp;|&nbsp;</span>
	{!! make_nav_link("/dispatch?rj=11", "Rejected Results") !!}<span class="test_type">&nbsp;&nbsp;</span>
			...
			<tr class="{{$tr_css}}"  role="alert">
				...
				<td align="center">
					...
					<ul class="dropdown-menu xworksheet_actions pull-right" role="menu" style="width:17em;">
						...
						<li><a 	worksheet="{{ $w->id }}" target="_blank"	href="eid_results?b={{$w->id}}&scd=y&pcr=y"><span class="glyphicon glyphicon-envelope">&nbsp;</span>Results: EID + Sickle Cell</a></li>
		...
		$('#tab_id').dataTable({
    		...
    		"fnDrawCallback": function( oSettings ) {
        		...
        		if ($(".dataTables_empty")[0]) {
					...
					deep_search.attr("href", "/dispatch?e404=" + batch_to_find)
