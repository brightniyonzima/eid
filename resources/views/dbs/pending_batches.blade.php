  ...
  <div class="panel-body">Batches Awaiting Approval</div>
    ...
    <table class="table table-striped " align="center" style="margin-top: 1em;" id="tab_id">
        ...
        <tr>
            ...
            <th style="text-align:center; padding:0.3em"><small>Task</small></th>
        </tr>
        </thead>
<?php 
    ...
    $SQL = "SELECT  batches.id AS batchID, batch_number, envelope_number, " .
                ...
                "   AND     sample_rejected = 'NOT_YET_CHECKED' " .
...
?>
    ...
    @for($i=0; $i < $nBatches; $i++ )
        ...
        <tr class='even'>
            ...
            <td class="td_col">
                <a href="/samples/{{ $row['batchID'] }}">Edit the batch</a> |
                <a href="/approve/{{ $row['batchID'] }}" title='Samples awaiting your approval'>Check/Approve Samples</a>
            </td>
        </tr>
    @endfor
    </tbody>
