                ...
                $SQL = "SELECT  batches.id AS batchID, batch_number, envelope_number, " .
                            ...
                            "FROM batches, dbs_samples " .
                                "WHERE batches.id = dbs_samples.batch_id " .
                                 "   AND dbs_samples.sample_rejected = 'YES' " .
                                    "GROUP BY (batch_id) ".
...
<?php       
                $SQL = "SELECT  id, infant_name, batch_id, pos_in_batch,sample_rejected FROM dbs_samples WHERE in_workSheet = 'NO' AND sample_rejected = 'YES'";
