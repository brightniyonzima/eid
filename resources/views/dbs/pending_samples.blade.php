    ...
    <table width="860px" align="center" border="0" id="batch_data" style="margin-top: 0.4em">
        ...
        <tr>
            ...
            <td>
                ...
                <!-- <input type="text" id="envelope_number" name="envelope_number" required="YES" tabindex="1"/> -->

                
                {!! Form::text('envelope_number', null, 
                                array("id"=>"envelope_number","readonly"=>"true", "required"=>"YES", "tabindex"=>"1") ) !!}
            ...
            <td>
                ...
                <!-- <input type="text"   name="batch_number" id="batch_number" tabindex="2" required="YES" /> -->
                {!! Form::text('batch_number', null, 
                                array("id"=>"batch_number", "readonly"=>"true", "required"=>"YES", "tabindex"=>"2") ) !!}


                <!-- <input type="hidden" name="batch_checksum" id="batch_checksum" /> -->
                    ...
                    @for($i=0; $i < $nFacilities; $i++)
                        ...
                        <?php   
                            ...
                            if( $facility->facility_id === $this_facility_id ){
                                ...
                                $this_facility = $facility->facility_name;
                                break;
                            }
                        ?>
                    @endfor
                        <div class="xl" style="width:225px;">{{ $this_facility }}</div>
