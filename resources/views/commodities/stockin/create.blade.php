...
<div id='d4' class="panel panel-default">
	<div class="panel-body">
		...
		<br><br>
		{!! Session::get('msge') !!}
		{!! Form::open(array('url'=>'commodities/stockin/store','id'=>'form_id')) !!}
		...
		<table class='table table-bordered'>
			...
			<tr>
				...
				<td>{!! MyHTML::text('quantity',"","form-control",'b') !!} </td>
			</tr>
			<tr>
				<td class='td_label'><label for='arr_date'>Arrival Date :</label></td>
				<td>{!! MyHTML::text('arrival_date',"","form-control",'arr_date') !!} </td>
			</tr>
			<tr>
				<td class='td_label'><label for='d'>Batch No.</label></td>
				<td>{!! MyHTML::text('batchno',"","form-control",'d') !!} </td>
			</tr>
			<tr>
				<td class='td_label'><label for='exp_date'>Expiry Date</label></td>
				<td>{!! MyHTML::text('expiry_date',"","form-control",'exp_date') !!} </td>
			</tr>
