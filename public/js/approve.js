...
$(function  () {
    ...
    $("#sample_rejected").change(function(){
        ...
        }else if (this.value === "Rejected FOR EID"){
    ...
    $('#save_dates').on('click', function () {
        ...
        var date_data = {};
            ...
            date_data.date_dispatched_from_facility = $("#new_date_dispatched_from_facility").val();
            date_data.date_rcvd_by_cphl = $("#new_date_rcvd_by_cphl").val();
        ...
        $.get(  "/bDate",
                ...
                function(d){ 
                    ...
                    if( d.error ){// show error message

                        $("#date_dispatched_from_facility.date_link")
                            .notify(  d.error , {position: "top center", className: "error"});
                    
                    }else{  // update UI:

                        setVal("#date_dbs_taken", $("#new_date_dbs_taken").val(), sample.sample_id);
                        setVal("#date_dispatched_from_facility", date_data.date_dispatched_from_facility );
                        setVal("#date_rcvd_by_cphl", date_data.date_rcvd_by_cphl);
                    }
...
//cxxx
    ...
    function ajax_go(){
        ...
        if(approval_data.sample_rejected === "YES"){
         ...
         if(approval_data.sample_rejected === "Rejected FOR EID"){
        ...
        $.get(  url,
                ...
                function(d){ 
                    ...
                    if( d.error ){// show error message
                        ...
                        $("#nSpots_div").notify(d.error, {position: "top center", className: "error"});
                        return;
                    }
        ...
        var all_rejected = true;
         ...
         samples.forEach(function (current_sample) {
            if( current_sample.sample_rejected == "NO" || 
                current_sample.sample_rejected == "Rejected FOR EID"|| 
