...
class BarcodeLib{ // functions originally in function.php
	 ...
	 */
	public static function display_select($filename) {
	 ...
	 * @param int $number
	 */
	public static function display_output($number) {
		$table_value = array('1','2','3');
		$table_text = array('Portable Network Graphics (PNG)',
	 ...
	 * @param float $dpi
	 */
	public static function display_dpi($output, $dpi) {
	 ...
	 * @param int $number
	 */
	public static function display_thickness($number) {
	 ...
	 * @param int $number
	 */
	public static function display_res($number) {
	 ...
	 * @param int $rotation
	 */
	public static function display_rotation($rotation) {
	 ...
	 * @param int $number
	 */
	public static function display_font($family, $size) {
	 ...
	 * @return string
	 */
	public static function next_color($restart = 0) {
		global $sys_conf;
		static $color = 0;
